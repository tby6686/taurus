package cn.com.taurus.system.controller;

import cn.com.taurus.common.api.ApiResult;
import cn.com.taurus.common.core.controller.BaseController;
...
public class SysUserController extends BaseController {
     ...
     * 获取用户分页列表
     */
    @ApiOperation(value = "获取用户分页列表", response = SysUser.class)
    @PostMapping("/getPageList")
    public ApiResult<Paging<SysUser>> getPageList(@RequestBody SysUserPageParam pageParam){
        Paging<SysUser> paging = sysUserService.getSysUserPageList(pageParam);
