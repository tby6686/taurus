package cn.com.taurus.framework.config.captcha;
...
public class CaptchaConfig
{
    ...
    public DefaultKaptcha getKaptchaBeanMath()
    {
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "cn.com.taurus.framework.config.captcha.KaptchaTextCreator");
        // 验证码文本字符间距 默认为2
