package cn.com.taurus.framework.web.exception;
...
public class GlobalExceptionHandler
{
    ...
    public ApiResult handleServiceException(ServiceException e, HttpServletRequest request)
    {
        ...
        return ObjectUtils.isNotEmpty(code) ? ApiResult.result(ApiCode.getApiCode(code), e.getMessage()) : ApiResult.fail(e.getMessage());
    }
